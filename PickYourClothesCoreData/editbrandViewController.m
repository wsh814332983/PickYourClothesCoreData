...
{  if([[segue identifier] isEqualToString:@"backtoedit"]){
    EditDetailTableViewController *tem=(EditDetailTableViewController *)[segue destinationViewController];
    tem.brand.text=_labelbrand.text;
    tem.clothedit.brand=_labelbrand.text;
}
